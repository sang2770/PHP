...
<div class="section py-5">
    <div class="container">
        <h3 class="text-center"><b>Các dịch vụ của chúng tôi</b></h3>
        <hr>
        <div class="row justify-content-center">
            <div class="col-lg-8 col-md-10 col-sm-12 col-sm-12 mb-3">
                <div class="input-group input-group-lg" id="search-field">
                    <input type="search" class="form-control form-control-lg  rounded-pill" aria-label="Search Service Field" id="search" placeholder="Tìm kiếm dịch vụ">
                ...
                <div id="collapse<?= $row['id'] ?>" class="collapse service_collapse" aria-labelledby="service<?= $row['id'] ?>" data-parent="#serviceAccordion">
                    <div class="card-body">
                        ...
                        <div class="text-center">
                            <button class="btn btn-primary btn-sm rounded-pill col-3 view_price" type="button" data-id="<?= $row['id'] ?>" data-name="<?= $row['name'] ?>"><i class="fa fa-tags"></i> Xem danh sách giá</button>
                        </div>
                    </div>
                </div>
            </div>
...
<script>
    $(function(){
        $('.view_price').click(function(){
            ...
            uni_modal("<b>"+name+" : Giá</b>", "services/price_list.php?id="+id)
        })
