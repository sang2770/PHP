...
<div class="card card-outline rounded-0 card-primary">
	<div class="card-header">
		<h3 class="card-title">Các loại dịch vụ</h3>
					...
					?>
						<tr>
							...
							<td class="text-center">
                                ...
                                <?php else: ?>
                                    <span class="badge badge-danger px-3 rounded-pill">Bảo trì</span>
                                <?php endif; ?>
                            </td>
							<td align="center">
								 <button type="button" class="btn btn-flat p-1 btn-default btn-sm dropdown-toggle dropdown-icon" data-toggle="dropdown">
				                  ...
				                  <div class="dropdown-menu" role="menu">
				                    ...
				                    <div class="dropdown-divider"></div>
				                    <a class="dropdown-item manage_price" href="javascript:void(0)" data-id="<?php echo $row['id'] ?>" data-name="<?php echo $row['name'] ?>"><span class="fa fa-tags text-muted"></span> Quản lí giá</a>
				                    <div class="dropdown-divider"></div>
...
<script>
	$(document).ready(function(){
		$('.delete_data').click(function(){
			_conf("Bạn có chắc muốn xóa dịch vụ này","delete_service",[$(this).attr('data-id')])
		})
		$('#create_new').click(function(){
			uni_modal("<i class='fa fa-plus'></i> Thêm dịch vụ","services/manage_service.php")
		})
		$('.view_data').click(function(){
			uni_modal("<i class='fa fa-tags'></i> Chi tiết dịch vụ","services/view_service.php?id="+$(this).attr('data-id'))
		})
		$('.manage_price').click(function(){
			uni_modal("<i class='fa fa-eye'></i> Quản lí giá dịch vụ - "+$(this).attr('data-name'),"services/manage_price.php?id="+$(this).attr('data-id'))
		})
		$('.edit_data').click(function(){
			uni_modal("<i class='fa fa-edit'></i> Cập nhật dịch vụ","services/manage_service.php?id="+$(this).attr('data-id'))
		})
		$('.table').dataTable({
			columnDefs: [
