...
<div class="card card-outline rounded-0 card-primary">
		...
		<div class="container-fluid">
			...
			<form action="" id="manage-user">	
				...
				<div class="form-group">
					...
					<small><i>Rời khỏi phần này nếu bạn đổi mật khẩu.</i></small>
                    <?php endif; ?>
				</div>
                <div class="form-group">
                    ...
                    <option value="2" <?php echo isset($meta['type']) && $meta['type'] == 2 ? 'selected' : '' ?>>Quản lí</option>
                    </select>
                </div>
				<div class="form-group">
	...
	<div class="card-footer">
			<div class="col-md-12">
				<div class="row">
					<button class="btn btn-sm btn-primary rounded-0 mr-3" form="manage-user">Lưu thông tin</button>
