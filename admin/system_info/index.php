		...
		<div class="card-body">
			<form action="" id="system-frm">
				...
				<div class="form-group">
					<label for="name" class="control-label">Tên Web</label>
			...
			<div class="form-group">
				<label for="" class="control-label">Ảnh nền trang admin</label>
				<div class="custom-file">
			...
			<div class="form-group">
				<label for="" class="control-label">Ảnh giới thiệu</label>
				<div class="custom-file">
				...
				<small><i>Chọn ảnh giới thiệu mới để tải lên</i></small>
			</div>
			<?php 
...
<script>
        ...
        $.ajax({
            ...
            success:function(resp){
                ...
                if(typeof resp =='object' && resp.status == 'success'){
                    ...
                    alert_toast("Tải ảnh lên thành công","Thành công");
                }else{
                    console.log(resp)
	...
	$(document).ready(function(){
		$('.rem_img').click(function(){
            _conf("Chắc chắn xóa hình này?",'delete_img',["'"+$(this).attr('data-path')+"'"])
        })
